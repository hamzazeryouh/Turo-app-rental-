...
namespace Turo.Controllers.cars
{
    ...
    public class CarController : BaseController<CarDto,UpdateCarDTo,CreateCarDTo, GetAllCarsQuery, GetByIdCarQuery, CreateCarCommand, UpdateCarCommand, DeleteCarCommand>
    {
